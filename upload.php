...
<body>
    <div class="header">
        ...
        <form action="/proses_upload.php">
            ...
            <input type="number" class="input-ukuran" id="ukuran1" name="ukuran1" pattern="[0-9]" min="1" max="999" required>
            <label> X </label>
            <input type="number" class="input-ukuran" id="ukuran2" name="ukuran2" pattern="[0-9]" min="1" max="999" required>
            <label> Meter </label>
            ...
            <label>Rp. </label>
            <input type="text" class="input-harga" id="harga" name="harga" pattern="[0-9]" required>
            <label> / Bulan </label>
